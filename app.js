...
const menuGroups = [
  ...
  group("canteen", "文科食堂 1F", "杂粮煎饼&粥铺窗口", "杂粮煎饼、小米南瓜粥、牛奶燕麦粥、荷叶绿豆粥、皮蛋瘦肉粥、紫薯百合粥、红糖薏米粥、火龙果玉米粥、酸辣汤、红枣养生黑米粥、疙瘩汤、鸡蛋肠粉、鲜肉肠粉", "文科组团"),
  group("canteen", "文科食堂 1F", "小街特色面窗口", "麻酱拌面、麻辣拌面、老北京肉沫炸酱面、番茄鸡蛋面、油泼面、小街燃面、小街火鸡面、鲜椒拌面、肉沫酸豆角面、小街特色汤面、火鸡面、燃面、鲜椒面、油泼面、酸豆角拌面、麻辣拌面", "文科组团"),
